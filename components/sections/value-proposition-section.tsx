        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          <div className="flex flex-col gap-12">
            <article className="p-8 rounded-2xl bg-surface-container border-l-4 border-primary">
              ...
              <div className="text-on-surface/70 leading-relaxed space-y-5">
                <p>
                  No dia a dia, isso significa menos tempo perdido consolidando
                  informações, reuniões orientadas por indicadores confiáveis e
                  decisões mais rápidas sobre onde agir, corrigir e investir.
                </p>
              </div>
            </article>
            ...
            <article className="p-8 rounded-2xl bg-surface-container border-l-4 border-accent">
              ...
              <div className="text-on-surface/70 leading-relaxed space-y-5">
                <p>Não entregamos apenas dashboards.</p>

                <p>
                  Atuamos na origem do problema, estruturando a lógica dos
                  dados, regras de negócio e indicadores para que cada análise
                  represente a realidade da operação.
                </p>

                <p>
                  É isso que transforma BI em decisão, e não apenas em
                  visualização.
                </p>
              </div>
            </article>
