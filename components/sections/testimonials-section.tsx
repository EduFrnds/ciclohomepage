...
export function TestimonialsSection() {
  return (
    <section id="testimonials" className="bg-surface-container/30 py-24">
      <div className="mx-auto max-w-7xl px-8">
        ...
        <div className="columns-1 gap-6 md:columns-2 lg:columns-3">
          {testimonials.map((testimonial, index) => (
            <article
              key={index}
              className="mb-6 break-inside-avoid rounded-2xl border border-outline-variant bg-surface-container p-6 transition-colors hover:border-primary/50"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <span className="block text-sm tracking-wide text-on-surface/60">
                    {testimonial.role}
                  </span>
                </div>
