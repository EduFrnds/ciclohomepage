...
import { LeadAssessmentModal } from "@/components/ui/lead-assessment-modal"
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-4 font-headline tracking-tight">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="hidden rounded-full border border-outline-variant px-5 py-2 font-medium text-on-surface/80 transition-all duration-300 hover:border-primary hover:text-white md:inline-flex"
            >
              Avaliar Meu Cenário
            </button>
